...
_RESOURCE_DIRECTORY = "Swarm_M138_GUI/resource"
...
setuptools.setup(
    ...
    description='Application to test communication with the Swarm M138 satellite modem',
    long_description=long_description,

    # The project's main homepage.
    url='https://docs.sparkfun.com/SparkFun_Swarm_M138_GUI/intro/',
    ...
    project_urls = {
        "Bug Tracker" : "https://github.com/sparkfun/SparkFun_Swarm_M138_GUI/issues",
        "Repository"   : "https://github.com/sparkfun/SparkFun_Swarm_M138_GUI"
    },
    # Choose your license
    license='MIT',
    ...
    download_url="https://github.com/sparkfun/SparkFun_Swarm_M138_GUI/releases",

    # What does your project relate to?
    keywords='Firmware SparkFun Swarm M138 Modem',

    # You can just specify the packages manually here if your project is
    # simple. Or you can use find_packages().
    packages=["Swarm_M138_GUI", "Swarm_M138_GUI/resource"],
    ...
    package_data={
        'Swarm_M138_GUI/resource': ['*.png', '*.jpg', '*.ico', '*.icns'],
    },
